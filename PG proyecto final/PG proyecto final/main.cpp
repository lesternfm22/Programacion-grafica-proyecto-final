...
int main()
{
   ...
   Model sta("modelos/sta/scene.gltf", glm::vec3(0.5f));  // Mitad de tamaño
    ...
    // All the faces of the cubemap in the correct order
    std::string facesCubemap[6] =
    {
        "skybox/px.png",    // GL_TEXTURE_CUBE_MAP_POSITIVE_X
        "skybox/nx.png",     // GL_TEXTURE_CUBE_MAP_NEGATIVE_X
        "skybox/py.png",      // GL_TEXTURE_CUBE_MAP_POSITIVE_Y
        "skybox/ny.png",  // GL_TEXTURE_CUBE_MAP_NEGATIVE_Y
        "skybox/pz.png",    // GL_TEXTURE_CUBE_MAP_POSITIVE_Z
        "skybox/nz.png"     // GL_TEXTURE_CUBE_MAP_NEGATIVE_Z
    };
    ...
    // Configure flip before loading textures
